...
| 1 | `capture.py` | ✅ Done | **22/22 pytest unit tests green (0.22s)**. Manual verification on real 2880×1800 @ 200% DPI desktop: monitor detected `(0, 0) 2880×1800`, cursor coords plausible, resolution picked `1280×800` (exact 16:10 match), scale factors `(2.25, 2.25)` uniform, `debug_capture.jpg` correctly shows Antigravity/LearnLoop desktop. Demo unscale `(640, 400) → (1440, 900)` (dead center of monitor). 100% runtime-detected, zero hardcoded monitor specs. | TBD (Task 9 in progress) |
